function [Ori, Sigma, WNNM_PSNR, WNNM_FSIM, WNNM_SSIM, PSNR_Final,FSIM_Final,SSIM_Final]     =  GSRC_Test_WNNM (Ori, Sigma)

randn ('seed',0);

fn               =     [Ori, '.tif'];

WNNM_fn               =     [Ori,'_WNNM_sigma_', num2str(Sigma),'.png'];

I                =     imread(fn);

WNNM_image                =     double(imread(WNNM_fn));
...
[Denoising ,WNNM_PSNR,WNNM_FSIM, WNNM_SSIM,iter]              =    GSRC_WNNM_Denoising( par, WNNM_image, par.err_or);
...
Final_denoisng= strcat(Ori,'_GSRC_WNNM_','_sigma_',num2str(Sigma),'_PSNR_',num2str(PSNR_Final),'_FSIM_',num2str(FSIM_Final),'_SSIM_',num2str(SSIM_Final),'.png');
